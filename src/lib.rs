...
pub use crate::model::board::{
    ...
    PcbBarcode, PcbBarcodeErrorCorrection, PcbBarcodeKind, PcbBoardGraphicShape, PcbBoardText,
    PcbBoardTextBox, PcbDimension, PcbDimensionStyle, PcbField, PcbFootprint,
    PcbFootprintSymbolLink, PcbGraphicShapeGeometry, PcbGroup, PcbItem, PcbPad, PcbPadStack,
    PcbPadType, PcbPadstackDrill, PcbReferenceImage, PcbSymbolPinInfo, PcbTextAttributes, PcbTrack,
